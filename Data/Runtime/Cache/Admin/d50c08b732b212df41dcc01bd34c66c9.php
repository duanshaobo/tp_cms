...
</script><!-- END SIDEBAR --><!-- BEGIN PAGE --><div class="page-content"><!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM--><div id="portlet-config" class="modal hide"><div class="modal-header"><button data-dismiss="modal" class="close" type="button"></button><h3>modal 标题</h3></div><div class="modal-body"><p>modal 内容</p></div></div><!-- END SAMPLE PORTLET CONFIGURATION MODAL FORM--><!-- BEGIN PAGE CONTAINER--><div class="container-fluid"><!-- BEGIN PAGE HEADER--><div class="row-fluid"><div class="span12"><!-- BEGIN STYLE CUSTOMIZER --><!--主题设置--><div class="color-panel hidden-phone"><a href="<?php echo U('Delcache/index');?>" title="清除系统缓存"><div class="color-mode-icons icon-color"></div></a></div><!-- END BEGIN STYLE CUSTOMIZER --><!-- BEGIN PAGE TITLE & BREADCRUMB--><h3 class="page-title">编辑轮播图</h3><!-- END PAGE TITLE & BREADCRUMB--></div></div><!-- END PAGE HEADER--><!-- BEGIN PAGE CONTENT--><div class="row-fluid"><div class="span12"><!-- BEGIN EXAMPLE TABLE PORTLET--><!--页面主体内容--><div class="portlet box light-grey"><div class="portlet-title"><div class="caption"><i class="icon-globe"></i>编辑轮播图</div><div class="actions"><a href="<?php echo U('index');?>" class="btn blue"><i class="icon-list"></i> 返回</a></div><div class="tools" style="margin:0 10px"><a href="javascript:;" class="collapse"></a></div></div><div class="portlet-body form"><!-- BEGIN FORM--><form action="<?php echo U('edit',array('id'=>I('get.id')));?>" method="post" class="form-horizontal form-bordered"><div class="control-group"><label class="control-label">标题</label><div class="controls"><input required="required" value="<?php echo ($info["title"]); ?>" type="text" name="title"  class="m-wrap span6" placeholder="标题" /></div></div><div class="control-group"><label class="control-label">链接地址</label><div class="controls"><input type="text" name="url" value="<?php echo ($info["url"]); ?>"  class="m-wrap span6" placeholder="链接地址"/></div></div><div class="control-group"><label class="control-label">图　　片</label><div class="controls"><input readonly name="spic" type="text" id="url1" value="<?php echo ($info["spic"]); ?>" class="m-wrap span6" placeholder="图片"/><input type="button" id="image1" value="选择图片" class="btn"/><font style="color:red">&nbsp;【图片大小不能超过1M】</font></div></div><div class="form-actions"><button type="submit" class="btn blue"><i class="icon-ok"></i> 提交</button><button type="button" class="btn" onclick='location.href="<?php echo U('index');?>"'>取消</button></div></form><!-- END FORM--></div></div><!--kindeditor--><link rel="stylesheet" href="/plugins/kindeditor/themes/default/default.css" /><script charset="utf-8" src="/plugins/kindeditor/kindeditor-min.js"></script><script charset="utf-8" src="/plugins/kindeditor/lang/zh_CN.js"></script><!--kindeditor--><!--uploadify--><script src="/plugins/uploadify/jquery.uploadify.min.js" type="text/javascript"></script><link href="/plugins/uploadify/uploadify.css" rel="stylesheet" type="text/css" ><!--uploadify--><script>	KindEditor.ready(function(K) {
		//初始化编辑器

...
function createwindow(){
	...
	h = getScrollTop();
	var str = '<div class="openwindow"><img src="/Public/Weixin/images/loadings.gif"  align="absmiddle"/></div>';
	$("body").append(str);
...
function ajaxopquyu(){
	...
	$("#opquyu").height($(document).height());
	$("#opquyubox").height($(document).height());

+ function($) {
  ...
  var show = function(html, className) {
    ...
    var style = '';
    if(className == 'weiui_toast_content_block') {

      style = "width: 200px;overflow: hidden;padding: 15px 15px;padding-bottom: 0px;min-height: 24px;top: 40%; left: 35%;";
    }
    var tpl = '<div class="weui_toast ' + className + '" style="' + style + '">' + html + '</div>';
  ...
  $.toast2 = function(text) {
    show('<p class="weui_toast_content">' + (text || "已经完成") + '</p>', 'weiui_toast_content_block');
...
+ function($) {
  ...
  var show = function(text) {
    ...
    var tpl = '<div class="weui_toptips weui_warn js_tooltips">' + text + '</div>';
    var dialog = $(tpl).appendTo(document.body);
